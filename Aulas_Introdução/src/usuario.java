...
public class usuario {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Novo Status TV --> Volume Atual ? " + smartTV.volume); // 23

        System.out.println("Status TV --> Canal Atual ? " + smartTV.canal);
        smartTV.mudarCanal(13);
        System.out.println("Novo Status TV --> Canal Atual ? " + smartTV.canal);
    }
}
